...
public class DoctorServiceImpl implements DoctorService {
    ...
    public ApiResponse submitDiagnosis(DiagnosisRequest request) {
        ...
        record.setTreatment(request.getProcedure()); 
        ...
        if (request.isSendToMonitoring() && request.getProcedureServiceId() != null) {
            ...
            procedureVisit.setDoctor(visit.getDoctor()); 
            ...
            procedureVisit.setStatus(VisitStatus.UNPAID); 
            ...
            procRecord.setNeedsProcedure(true); 
